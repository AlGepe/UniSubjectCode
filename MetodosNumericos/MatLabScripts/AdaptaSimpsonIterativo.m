function Itot = AdaptaSimpsonIterativo(f,a,b,epsilon)
...
while auxA ~= b
    ...
    Ione = SimpsonSimp(f, [auxA;auxB]); %1st approx of integral
    Itwo = SimpsonSimp(f,[auxA;auxMid])+SimpsonSimp(f,[auxMid;auxB]);
    %2nd approx
