...
%Siguiendo el m?todo propuesto calculamos cada componenete de X_0 using M
while error_i < n
    error_i = 0;
...
display (X);% we plot results (both X_k+1, number of iterations and error)
display ( abs(error) );
display (count);
display ( converge );